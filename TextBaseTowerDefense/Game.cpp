...
void Game::Go()
{
	...
	world.SpawnEnemy(world.GetStart(), { 5.0f,5.0f }, "Goblin", mesh, Goblin);
	world.SpawnEnemy(world.GetStart(), { 5.0f,5.0f }, "Imp1", mesh, Imp);
	world.SpawnEnemy(world.GetStart(), { 5.0f,5.0f }, "Imp2", mesh, Imp);
	world.SpawnEnemy(world.GetStart(), { 5.0f,5.0f }, "Imp3", mesh, Imp);
	world.SpawnEnemy(world.GetStart(), { 5.0f,5.0f }, "Imp4", mesh, Imp);
	world.SpawnEnemy(world.GetStart(), { 5.0f,5.0f }, "ArmoredGoblin", mesh, ArmoredGoblin);
	world.SpawnEnemy(world.GetStart(), { 5.0f,5.0f }, "Riese", mesh, Riese);
